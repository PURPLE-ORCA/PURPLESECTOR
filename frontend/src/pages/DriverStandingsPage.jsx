...
// Team color mapping based on real F1 teams
const teamColors = {
    ...
    return (
      ...
      >
        ...
        >
          ...
          <div className="text-center">
            <div className="font-semibold">
              {top3[1].driver?.name} {top3[1].driver?.surname}
            </div>
        ...
        >
          ...
          <div className="text-center">
            <div className="font-bold text-lg">
              {top3[0].driver?.name} {top3[0].driver?.surname}
            </div>
            <div className="text-sm text-gray-500 dark:text-gray-400">
              {top3[0].team?.teamName}
            </div>
          </div>
          <div className="mt-4 px-4 py-2 rounded-md bg-red-600 text-white font-mono font-bold">
            {top3[0].points} PTS
          </div>
        ...
        >
          ...
          <div className="text-center">
            <div className="font-semibold">
              {top3[2].driver?.name} {top3[2].driver?.surname}
            </div>
            <div className="text-sm text-gray-500 dark:text-gray-400">
          ...
          >
            ...
            <div className="p-4">
              <div className="flex justify-between items-start mb-3">
                <div
                  className={`text-2xl font-bold ${standing.position <= 3 ? "text-red-600" : "text-gray-800 dark:text-white"}`}
                >
                  {standing.position}
                </div>
              ...
              <div className="inline-block px-3 py-1 rounded-full text-sm bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-300">
        ...
        <table className="w-full">
          ...
          <tbody>
            {driverStandings.map((standing, index) => (
              <tr
                key={standing.driver?.driverId || standing.position}
                className="border-b border-gray-200 dark:border-gray-800 hover:bg-red-50 dark:hover:bg-red-900/10 transition-colors duration-200"
              >
                <td
                  className={`py-4 px-4 font-medium ${standing.position <= 3 ? "text-red-600 font-bold" : ""}`}
                >
                  <div className="flex items-center">
                    {index > 0 &&
                      standing.position <
                        driverStandings[index - 1].position && (
                ...
                <td className="py-4 px-4 font-bold text-right text-red-600">
                  {standing.points}
                </td>
